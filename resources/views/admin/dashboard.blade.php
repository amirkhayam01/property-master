        ...
        <div class="container">
            ...
            <div class="row mt-4" >
                ...
                <div class="row mt-4">
                    ...
                    <div class="card" >
                        <div class="card-body" >
                        <p class="card-text text-uppercase text-muted" style="margin-bottom: 5px;" >Plot Inquiries</p>
                        <div class="row">
                            <div class="col-4">
                            <h2>73</h2>
                            <p>-7.6%</p>
                    ...
                    <div class="card" >
                        <div class="card-body">
                        <p class="card-text text-uppercase text-muted" style="margin-bottom: 5px;">Plot Sales</p>
                        <div class="row">
                            <div class="col-4">
                            <h2>73</h2>
                            <p>-7.6%</p>
